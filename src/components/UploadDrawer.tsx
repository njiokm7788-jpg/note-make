...
export function UploadDrawer({
  ...
  const annotatedInputId = `upload-drawer-annotated-${useId()}`;
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        ...
        `}
      >
        <div className="bg-white rounded-t-2xl shadow-xl border-t border-slate-200 max-h-[85vh] overflow-y-auto">
          <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200">
            <div className="min-w-0">
              <h2 className="text-sm font-semibold text-slate-800">上传图片</h2>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
              <h4 className="text-xs font-semibold text-slate-700 mb-2">小提示</h4>
